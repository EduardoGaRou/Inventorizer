<?php include_once("../Controllers/validateSession.php")?>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto ">
                <li class="nav-item active">
                    <a class="nav-link font-weight-bold text-center " href="#">Home</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link font-weight-bold text-center " href="#">Stash</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link font-weight-bold text-center " href="#">Categories</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link font-weight-bold text-center " href="#">Items</a>
                </li>
            </ul>
